...
<body>
  <?php
   ...
   <?php
     $bildirimler="";
       $sorgu=mysqli_query($baglanti,"SELECT*FROM grup_bildirimi INNER JOIN kullanicilar ON grup_bildirimi.gonderici_id=kullanicilar.kullanici_id where grup_bildirimi.alici_id='$id'");
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
      ...
      <form class="form-inline my-2 my-lg-0 text-left search col-md-2" style="float: left;">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item col-3 col-md-2">
        <a class="nav-link" href="mesajlar.php"><i class="fa fa-envelope"></i><span class="headerIcerik">Mesajlar</span></a>
        </li>
        <li class="nav-item  col-3 col-md-2">
